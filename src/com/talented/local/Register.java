...
public class Register extends Activity implements OnClickListener{
	...
	private EditText user, pass, emailTE;
   ...
   // private static final String REGISTER_URL = "http://xxx.xxx.x.x:1234/webservice/register.php";
    ...
    //testing on Emulator:
    private static final String REGISTER_URL = "http://lordwebmaster.com/ProjectR/android_api/register.php";
  ...
  //testing from a real server:
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		emailTE = (EditText)findViewById(R.id.emailTE);
		...
		busName = (EditText)findViewById(R.id.etBus);
		*/
		...
		protected String doInBackground(String... args) {
            ...
            */
            ...
            try {
                ...
                /*
                params.add(new BasicNameValuePair("zip", zipS));
                params.add(new BasicNameValuePair("state", stateS));
                params.add(new BasicNameValuePair("city", cityS));
                
                params.add(new BasicNameValuePair("address", addressS));
                params.add(new BasicNameValuePair("busName", busNameS));
                */
